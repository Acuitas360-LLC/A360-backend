...
def main():
    ...
    parser.add_argument("--input", default="final_agent_trace2.json", help="Path to agent_trace.json")
    parser.add_argument("--index_out", default="faiss_index3.bin", help="Output FAISS index file")
    parser.add_argument("--payload_out", default="payload_store3.json", help="Output payload store file")
