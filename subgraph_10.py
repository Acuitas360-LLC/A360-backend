...
def summarizer_node(state: AgentState):
    ...
    prompt=f"""
        ...
        3. findings
        Lead with the most significant result. Use specific figures, entity names, and comparisons. Where growth metrics appear:
        - Presence of both total growth and daily average growth → the period is complete.
        - Presence of only daily average growth → at least one period is incomplete (typically the most recent); state this explicitly.
        ...
        Findings
        - Each bullet captures one significant result — a specific figure, entity name, or comparison.
        - Include 2–4 bullets. Each bullet should be one concise sentence.
        - If a period is incomplete (only daily average growth present, no total growth), include it as a bullet here.
        ...
        - Include 1–3 bullets. Each bullet should be one concise sentence.
        ...
        DEDUPLICATION RULE:
        Every bullet must carry unique information. Remove any bullet that restates or rephrases a point already made elsewhere — even in different wording. Fewer sharp bullets is always preferable to padded sections. If a section has nothing unique to add, omit it entirely.
